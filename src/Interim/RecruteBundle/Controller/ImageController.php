...
use Interim\RecruteBundle\Entity\Image;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('InterimRecruteBundle:Image')->findAll();

        return $this->render('InterimRecruteBundle:Image:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('InterimRecruteBundle:Image:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InterimRecruteBundle:Image')->find($id);
        ...
        return $this->render('InterimRecruteBundle:Image:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('InterimRecruteBundle:Image:edit.html.twig', array(
            'entity'      => $entity,
