...
use Recover\ErecoverBundle\Entity\Role;
use Recover\ErecoverBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RecoverErecoverBundle:Role')->findAll();

        return $this->render('RecoverErecoverBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RecoverErecoverBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RecoverErecoverBundle:Role')->find($id);
        ...
        return $this->render('RecoverErecoverBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RecoverErecoverBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
