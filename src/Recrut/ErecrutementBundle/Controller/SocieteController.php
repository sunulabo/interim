...
use Recrut\ErecrutementBundle\Entity\Societe;
use Recrut\ErecrutementBundle\Form\SocieteType;
...
class SocieteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RecrutErecrutementBundle:Societe')->findAll();

        return $this->render('RecrutErecrutementBundle:Societe:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RecrutErecrutementBundle:Societe:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RecrutErecrutementBundle:Societe')->find($id);
        ...
        return $this->render('RecrutErecrutementBundle:Societe:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RecrutErecrutementBundle:Societe:edit.html.twig', array(
            'entity'      => $entity,
