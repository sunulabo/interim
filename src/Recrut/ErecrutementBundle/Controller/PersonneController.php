...
class PersonneController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('personnee_index', array('id' => $entity->getId())));
        }

        return $this->render('RecrutErecrutementBundle:Personnee:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Personne $entity)
    {
        $form = $this->createForm(new PersonneType(), $entity, array(
            'action' => $this->generateUrl('personnee_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new PersonneType(), $entity, array(
            'action' => $this->generateUrl('personnee_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('personnee_edit', array('id' => $id)));
        }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('personnee_delete', array('id' => $id)))
            ->setMethod('DELETE')
